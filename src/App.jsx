  ...
  <>
    ...
    {!showWelcome && (
      <>
        ...
        {/* Footer */}
        <footer className="relative py-16 mt-16 border-t border-slate-200 bg-white overflow-hidden text-slate-500">
          <div className="absolute inset-0 blueprint-grid-system opacity-[0.02]" />
          
          <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-center max-w-6xl">
            ...
            <div className="text-right space-y-1">
              <span className="block text-xs font-semibold text-slate-800 uppercase tracking-wider technical-label">© 2026 All Rights Reserved.</span>
